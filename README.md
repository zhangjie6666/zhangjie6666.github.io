...
## 演示地址
[https://zhangjie6666.github.io][1]

## 项目源码
[https://github.com/zhangjie6666/vblog][3]
...
## 快速使用
搭建博客只需2步
- 点击github头像旁边的 "+" 号 选择 ```Import repository ```克隆地址填 ```https://github.com/zhangjie6666/zhangjie6666.github.io ```项目名填 ```你的用户名.github.io ```
- 克隆完成后 修改文件 ```/static/configuration.json``` 中的 ```githubUsername``` 为自己的github用户名


类似演示地址其中 GitHub-zhangjie6666 为我的用户名


现在 ```https://你的用户名.github.io``` 就是你的个人博客了,例如[https://zhangjie6666.github.io][1]
...
作者 *zhangjie6666*
  ...
  [1]: https://zhangjie6666.github.io
  [2]: https://github.com/zhangjie6666/zhangjie6666.github.io
  [3]: https://github.com/zhangjie6666/vblog
